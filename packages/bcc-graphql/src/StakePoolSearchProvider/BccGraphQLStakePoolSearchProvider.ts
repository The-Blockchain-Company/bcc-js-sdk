import { ProviderError, ProviderFailure, Bcc, StakePoolSearchProvider, util } from '@bcc-sdk/core';
...
export const createGraphQLStakePoolSearchProvider = (
  ...
  return {
    async queryStakePools(fragments: string[]): Promise<Bcc.StakePool[]> {
              ...
              ? {
                  ...
                  ext: ext
                    ? {
                        ...
                        pool: {
                          ...ext.pool,
                          status: ext.pool.status as unknown as Bcc.PoolStatus
                        }
                      }
                    : undefined
                }
