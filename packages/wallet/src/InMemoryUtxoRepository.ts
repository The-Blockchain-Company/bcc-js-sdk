import { WalletProvider, Bcc, cslUtil, CSL, coreToCsl, cslToCore } from '@bcc-sdk/core';
import { dummyLogger, Logger } from 'ts-log';
import { InputSelector, SelectionConstraints, SelectionResult } from '@bcc-sdk/cip2';
...
const utxoEquals = ([txIn1]: Bcc.Utxo, [txIn2]: Bcc.Utxo): boolean =>
...
export class InMemoryUtxoRepository extends Emittery<UtxoRepositoryEvents> implements UtxoRepository {
  #delegationAndRewards: Bcc.DelegationsAndRewards;
  #inputSelector: InputSelector;
  #keyManager: KeyManager;
  #logger: Logger;
  #provider: WalletProvider;
  #utxoSet: Set<Bcc.Utxo>;
  #lockedUtxoSet: Set<Bcc.Utxo> = new Set();
  #lockedRewards = 0n;
