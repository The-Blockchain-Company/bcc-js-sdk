...
import { WalletProvider, ProviderError, ProviderFailure, CSL, Bcc } from '@bcc-sdk/core';
...
export class InMemoryTransactionTracker extends Emittery<TransactionTrackerEvents> implements TransactionTracker {
  ...
  async #checkTransactionViaProvider(hash: Bcc.Hash16, invalidHereafter: Bcc.Slot): Promise<void> {
