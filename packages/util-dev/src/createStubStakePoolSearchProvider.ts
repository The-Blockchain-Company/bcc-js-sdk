import { StakePoolSearchProvider } from '@bcc-sdk/core';
import { StakePool } from '@bcc-sdk/core/src/Bcc';
...
export const somePartialStakePools: StakePool[] = [
  ...
  },
  {
    ...
    metadata: {
      name: 'VEGASPool',
      description: 'VEGAS TestNet(2) BCC Pool',
      ticker: 'VEGA2',
      homepage: 'https://www.bcc.vegas'
    }
  }
] as StakePool[];
